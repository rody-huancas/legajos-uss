...
export const teachingCategorySchema = z.object({
  ...
  lCategoriaDoc     : z.object({ value: z.number(), label: z.string() }).optional().refine((val) => val !== undefined, { message: REQUIRED_FIELD("Categoría Docente") }),
...
export type TeachingCategorySchemaType = z.infer<typeof teachingCategorySchema>;