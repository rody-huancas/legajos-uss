...
import { ILanguageProficiency } from "../models/language-proficiency.model";
/* Config */
...
export const columnsLanguageProficiency = ({ handleDelete, handleEdit }: Props): IColumn<ILanguageProficiency>[] => [
    {
      header: "Opciones",
      render: (row) => (
