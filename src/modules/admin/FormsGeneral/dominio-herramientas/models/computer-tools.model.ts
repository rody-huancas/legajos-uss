...
export type IResponseComputerTools = IBaseResponse<IComputerTools[]>;
export type IResponseComputerTool  = IBaseResponse<IComputerTools>;

export interface IComputerTools {
...
export interface IComputerToolsPost {
