...
export const universityAdministrativeBurdenSchema = z.object({
  ...
  vCargo            : z.object({ value: z.number(), label: z.string() }).optional().refine((val) => val !== undefined, { message: REQUIRED_FIELD("Cargo") }),
  cLegGraOtraInst   : z.string().min(1, { message: REQUIRED_FIELD("Nombre de Institución") }),
  cLegGraDocument   : z.string().min(1, { message: REQUIRED_FIELD("Documento") }),
...
export type UniversityAdministrativeBurdenType = z.infer<typeof universityAdministrativeBurdenSchema>;