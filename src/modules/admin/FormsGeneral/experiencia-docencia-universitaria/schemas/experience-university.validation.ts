...
export const experienceUniversitySchema = z.object({
  ...
  lCategoriaDoc     : z.object({ value: z.number(), label: z.string() }).optional().refine((val) => val !== undefined, { message: REQUIRED_FIELD("Cargo") }),
...
export type ExperienceUniversitySchemaType = z.infer<typeof experienceUniversitySchema>;